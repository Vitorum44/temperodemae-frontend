...
btnSendCode?.addEventListener('click', async () => {
  ...
  try {
    ...
    await apiSend('/auth/request-reset', 'POST', {
      phone: email  // o campo chama "email" mas o usuário digita o telefone
    });

    recFb.style.color = 'green';
    recFb.textContent = "Enviamos uma nova senha para o seu e-mail cadastrado!";
